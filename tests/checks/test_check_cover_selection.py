...
from albums.checks.check_cover_selection import CheckCoverSelection
...
class TestCheckCoverSelection:
    ...
    def test_album_pictures_but_no_front_cover(self, mocker):
        ...
        mock_get_embedded_image_data = mocker.patch("albums.checks.check_cover_selection.get_embedded_image_data", return_value=[image_data])
    ...
    def test_album_picture_files_no_front_cover(self, mocker):
        ...
        mock_rename = mocker.patch("albums.checks.check_cover_selection.rename")
        result.fixer.fix(result.fixer.options[result.fixer.option_automatic_index])
    ...
    def test_has_unmarked_cover_source_file(self, mocker):
        ...
        update_picture_files_mock = mocker.patch("albums.checks.check_cover_selection.operations.update_picture_files")
