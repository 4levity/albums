...
!!!note
    ...
    ID3 `TDRL` is read as a deprecated alias for the release date and
    converted to `TDRC` by the `legacy-fields` check; see
    [tag handling](./tag_technical.md#id3-release-date).
