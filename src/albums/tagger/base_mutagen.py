...
from .types import AlbumPicture, BasicTag, MutagenFileType, ScanResult, StreamInfo, TaggerFile
...
class AbstractMutagenTagger(TaggerFile):
    ...
    def scan(self) -> ScanResult:
        ...
        return ScanResult(self._scan_tags(), self._scan_pictures(), stream_info)
