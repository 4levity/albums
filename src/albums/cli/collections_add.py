...
from albums.database.collections_by_name import collections_by_name
from albums.entities import AlbumCollectionAssociation
...
@click.argument("collection_names", nargs=-1)  # pyright: ignore[reportUnknownMemberType]
